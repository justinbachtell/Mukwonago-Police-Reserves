...
type AssignedEquipmentWithDates = Omit<AssignedEquipment, 'checked_out_at' | 'checked_in_at' | 'expected_return_date' | 'created_at' | 'updated_at' | 'equipment'> & {
  checked_out_at: Date;
            ...
            : (
                assignedEquipment.map(item => (
                  ...
                  >
                    ...
                    <TableCell>{formatDate(item.checked_out_at)}</TableCell>
                    <TableCell>
                      {item.expected_return_date ? formatDate(item.expected_return_date) : 'Not specified'}
                    </TableCell>
                    <TableCell>
                      {item.checked_in_at ? formatDate(item.checked_in_at) : 'Not returned'}
                    </TableCell>
                    <TableCell>
